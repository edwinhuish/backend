<template>
  <div class="h-panel w-1200">
    ...
    <div class="h-panel-body">
      ...
      <div class="float-box mb-10">
        <p-del-button permission="addons.TencentCloudHls.videos.submitTransTask" text="批量提交" @click="multiSubmit()" />
      ...
      <div class="float-box mb-10">
        <Table ref="table" :datas="datas" :checkbox="true">
          <TableItem title="课程">
          ...
          <TableItem prop="tencent_video_id" title="视频ID" />
          <TableItem title="转码">
            <template slot-scope="{ data }">
