  ...
  <div class="h-panel w-1000">
    ...
    <div class="h-panel-body">
      <div class="float-box mb-10">
        <Form>
          <FormItem label="添加用户">
            <textarea v-model="mobiles" placeholder="一行一个手机号" />
          </FormItem>
          <FormItem>
            <p-button glass="h-btn h-btn-s h-btn-primary" permission="addons.Paper.paper.users.add" text="添加" @click="userAdd()" />
...
export default {
  ...
  methods: {
    ...
    userAdd() {
      const mobiles = this.mobiles.split('\n')
      if (mobiles.length === 0) {
