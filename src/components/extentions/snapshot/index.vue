    ...
    <div class="h-panel-body">
      <div class="float-box mb-10">
        <Form>
          <Row>
            <Cell :width="6">
              <FormItem label="会员">
                <Select v-model="filter.type" :filterable="true" :datas="typeRows" key-name="id" title-name="name" />
              </FormItem>
            </Cell>
            <Cell :width="6">
              <FormItem label="用户ID">
            ...
            <Cell :width="6">
              <FormItem label="资源id">
                <input v-model="filter.other_id" type="number" placeholder="资源ID">
              </FormItem>
            </Cell>
            <Cell :width="6">
              <FormItem>
      ...
      <div class="float-box mb-10">
        <Table :loading="loading" :datas="datas">
          ...
          <TableItem prop="type_title" title="资源" />
          <TableItem title="用户" :width="100">
            <template slot-scope="{ data }">
              <span>{{ data.user.nick_name }}</span>
            </template>
          </TableItem>
          <TableItem prop="count" title="照片" :width="50" />
          <TableItem prop="last_snap_at" title="最后拍照时间" :width="100" />
