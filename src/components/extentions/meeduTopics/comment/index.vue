<template>
  <div class="h-panel w-1200">
    ...
    <div class="h-panel-body">
      ...
      <div class="float-box mb-10">
        <p-del-button permission="addons.meedu_topics.topic.comment.check" text="批量审核通过" @click="multiCheck(1)" />
        <p-del-button permission="addons.meedu_topics.topic.comment.check" text="批量审核拒绝" @click="multiCheck(0)" />
      </div>
      <div class="float-box mb-10">
        <Table ref="table" :loading="loading" :datas="datas" :checkbox="true">
          ...
          <TableItem prop="created_at" title="时间" :width="150" />
          ...
          <TableItem title="操作" align="center" :width="100" fixed="right">
            <template slot-scope="{ data }">
              <p-del-button permission="addons.meedu_topics.topic.comment.delete" @click="remove(datas, data)" />
            </template>
          </TableItem>
        </Table>
      </div>
