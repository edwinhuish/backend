      ...
      <div class="float-box">
        <Table :loading="loading" :datas="datas">
          ...
          <TableItem title="操作" align="center" :width="200">
            <template slot-scope="{ data }">
              <p-del-button permission="addons.MultiLevelShare.goods.delete" @click="remove(datas, data)" />
              <p-button glass="h-btn h-btn-s h-btn-primary" permission="addons.MultiLevelShare.goods.edit" text="编辑" @click="edit(data)" />
            </template>
          </TableItem>
        </Table>
      </div>
