  ...
  <div class="h-panel w-1000">
    ...
    <div class="h-panel-body">
      ...
      <div class="float-box mb-10">
        ...
        <p-del-button permission="addons.Zhibo.chat.delete" text="批量删除" @click="deleteSubmit()" />
      </div>
      <div class="float-box mb-10">
        <Table ref="table" :loading="loading" :datas="datas" :checkbox="true">
          ...
          <TableItem title="内容" prop="content" />
          <TableItem title="时间" prop="created_at" :width="200" />
        </Table>
      </div>
